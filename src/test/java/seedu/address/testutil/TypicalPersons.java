...
import static seedu.address.logic.commands.CommandTestUtil.VALID_METADATA;
...
public class TypicalPersons {
    ...
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            ...
            .withAmount("50.00").withMetadata("I support Manchester United.").build();
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withRoles(VALID_ROLE_FRIEND)
            .withCcas("NUS Cycling").withMetadata(VALID_METADATA).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withRoles(VALID_ROLE_HUSBAND, VALID_ROLE_FRIEND)
            .withCcas("NUS Cycling").withMetadata(VALID_METADATA)
            .build();
